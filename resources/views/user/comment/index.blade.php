...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <h4 class="font-weight-bold py-3 mb-4">
      <span class="text-muted font-weight-light"></span>Add Comment
    </h4>
    ...
    <div class="card">
      <h6 class="card-header float-right">
        <button type="button" id="add_new_button" data-toggle="modal" data-target="#ajaxModal"
            class="btn btn-primary rounded-pill d-block"><span class="ion ion-md-add"></span>&nbsp; Add Role
        </button>
      </h6>
